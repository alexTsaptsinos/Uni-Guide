...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    University *tempUniversity = _universities[indexPath.row];
        ...
        //universityPageTabBarController.navigationItem.title = tempUniversity.name;
   // [self.navigationController.navigationBar setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIFont fontWithName:@"Arial" size: 5], NSFontAttributeName, nil]];
    ...
    //universityTitle.adjustsFontSizeToFitWidth = YES;
    //[universityTitle sizeToFit];
