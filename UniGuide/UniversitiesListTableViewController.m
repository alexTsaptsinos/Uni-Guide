...
@synthesize universities,alphabetsArray,universitiesUKPRNS,sections,hasSearchingCommenced,sortedUniversities;
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSInteger originalIndexPath = [self.universities indexOfObject:cell.textLabel.text];
